...
class Wallpapers(models.Model):
    ...
    view_count = models.PositiveIntegerField(default=0, verbose_name=" 详情浏览量",null= True, blank=True)
    exposure_count = models.PositiveIntegerField(default=0, verbose_name="曝光量",null= True, blank=True)
    comment_count = models.PositiveIntegerField(default=0, verbose_name="评论数",null= True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True, verbose_name="创建时间")
